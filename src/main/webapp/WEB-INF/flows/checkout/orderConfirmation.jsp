                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                        <address>
                            ...
                            <br> <abbr title="Numer telefonu">Nr tel:</abbr>
                    ...
                    <table class="table table-hover">
                        ...
                        <c:forEach var="cartItem" items="${order.cart.cartItems}">
                            <tr>
                                ...
                                <td class="col-md-1" style="text-align: center">${cartItem.value.quantity}</td>
                        ...
                        <tr>
                            <td></td>
                            <td></td>
                            <td class="text-right"><h4><strong>suma: </strong></h4></td>
                            <td class="text-right text-danger"><h4><strong>$${order.cart.grandTotal}</strong></h4></td>
                        </tr>
                        </tbody>
                    </table>

                    <button id="back" class="btn btn-default" name="_eventId_backToCollectShippingDetail">Cofnij
                    </button>

                    <button type="submit" class="btn btn-success" name="_eventId_orderConfirmed">Zatwierdź
                        <span class="glyphicon glyphicon-chevron-right"></span>
                    </button>

                    <button id="btnCancel" class="btn btn-default" name="_eventId_cancel">Anuluj
                    </button>
                </div>
            </div>
        </form:form>
